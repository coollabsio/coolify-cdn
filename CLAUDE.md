...
Coolify CDN is a lightweight Go-based CDN server that serves static JSON files and images with HTTP caching support. It's designed to be deployed as a minimal Docker container (scratch-based, ~10MB) with multi-architecture support (AMD64/ARM64).
